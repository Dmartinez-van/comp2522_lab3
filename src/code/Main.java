...
// Create IPod objects
        ...
        final IPod ipod2;
        final IPod ipod3;
        ipod1 = new IPod(80.0, 300); // 300 songs, max volume 80.0 dB
        ipod2 = new IPod(85.5, 400); // 400 songs, max volume 85.0 dB
        ipod3 = new IPod(70.0, 300); // 300 songs, max volume 70.0 dB
